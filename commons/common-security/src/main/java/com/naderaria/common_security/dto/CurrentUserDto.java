...
public class CurrentUserDto implements UserDetails {
    ...
    public CurrentUserDto( Long id, String username, String password,boolean accountNonExpired, boolean accountNonLocked, boolean credentialsNonExpired, boolean enable){
        setId(id);
